...
The manifest and npm package name both use `recursive-board`, and the CLI binary is `wi`. A pushed version tag publishes the npm package through the release workflow.
